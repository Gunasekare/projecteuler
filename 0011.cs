//Problem - Euler Problem #11 (Largest product in a grid)
//URL     - https://projecteuler.net/problem=11
//Author  - Gunasekare
//Date    - 2020-05-13
//Version - 1
//Des     - Using an in-memory grid instead of reading the data off a file.
...
namespace _0011
{
    class Program
    {
        ...
        {
            //I'm not particularly proud of this line
            Console.WriteLine(Math.Max(RDiagonal(),Math.Max(LDiagonal(), Math.Max(Vertical(),Horizontal()))));
            
        }

        //Check products down and left
        static int LDiagonal ()
        {
            int product = 0;
            int maxProduct = 0;
        ...
        //Check products vertically down
        static int Vertical ()
        {
            int product = 0;
            int maxProduct = 0;
        ...
        //Check products horizontally to the left
